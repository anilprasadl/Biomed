    ...
    <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">BIO MET</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        ...
        <!--   you can change the color of the filter page using: data-color="blue | azure | green | orange | red | purple" -->
                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="userid" placeholder="Enter email" class="form-control input-no-border">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer text-center">
                                        <button type="submit" value="submit" name="submit" class="btn btn-fill btn-wd ">Let's go</button>
        	...
        	<footer class="footer footer-transparent">
                <div class="container">
                    <div class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> by Anil
                    </div>
                </div>
            </footer>
        </div>
